<#
.SYNOPSIS
    Configures Windows 11 to disable AutoPlay on all drives to meet STIG WN11-CC-000190.
...
.NOTES
    ...
    STIG Page       : https://stigaview.com/products/win11/v2r5/WN11-CC-000190/
...
if ($makeCompliant) {
    ...
    Write-Host "AutoPlay policy has been configured."
} else {
