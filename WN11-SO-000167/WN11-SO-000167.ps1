<#
.SYNOPSIS
    Configures Windows 11 to restrict remote calls to the Security Account Manager (SAM) to meet STIG WN11-SO-000167.
...
.NOTES
    ...
    STIG Page       : https://stigaview.com/products/win11/v2r5/WN11-SO-000167/
...
$policyName = 'RestrictRemoteSAM'
$requiredValue = 'O:BAG:BAD:(A;;RC;;;BA)'
...
if ($configuredValue -ceq $requiredValue) {
...
if ($makeCompliant) {
    ...
    New-ItemProperty -Path $policyPath -Name $policyName -PropertyType String -Value $requiredValue -Force | Out-Null
    Write-Host "RestrictRemoteSAM registry setting has been configured."
} else {
