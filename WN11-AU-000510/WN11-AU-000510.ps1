<#
.SYNOPSIS
    Configures the Windows 11 System event log maximum size to meet STIG WN11-AU-000510.
...
.NOTES
    ...
    STIG Page       : https://stigaview.com/products/win11/v2r5/WN11-AU-000510/
...
$policyPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\EventLog\System'
$policyName = 'MaxSize'
$requiredKB = 32768
...
if ($makeCompliant) {
    ...
    Write-Host "System log maximum size policy has been configured."
} else {
