<#
.SYNOPSIS
    Configures Windows 11 to disable camera access from the lock screen to meet STIG WN11-CC-000005.
...
.NOTES
    ...
    STIG Page       : https://stigaview.com/products/win11/v2r5/WN11-CC-000005/
...
if ($makeCompliant) {
    ...
    Write-Host "Lock screen camera policy has been configured."
} else {
