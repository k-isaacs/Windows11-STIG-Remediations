<#
.SYNOPSIS
    Configures the Windows 11 Application event log maximum size to meet STIG WN11-AU-000500.
...
.NOTES
    ...
    STIG Page       : https://stigaview.com/products/win11/v2r5/WN11-AU-000500/
...
if ($makeCompliant) {
    ...
    Write-Host "Application log maximum size policy has been configured."
} else {
