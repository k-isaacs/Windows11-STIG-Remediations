<#
.SYNOPSIS
    Configures Windows 11 to disable WDigest Authentication to meet STIG WN11-CC-000038.
...
.NOTES
    ...
    STIG Page       : https://stigaview.com/products/win11/v2r5/WN11-CC-000038/
...
$policyPath = 'HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\Wdigest'
$policyName = 'UseLogonCredential'
$requiredValue = 0
...
if ($makeCompliant) {
    ...
    Write-Host "WDigest Authentication registry setting has been configured."
} else {
